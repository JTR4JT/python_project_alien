...
class AlienInvasion:
    ...
    def _create_fleet(self):
        ...
        available_space_x = (self.settings.screen_width - (2 * alien_height) - ship_height)
        number_rows = available_space_x // (3 * alien_height)
    ...
    def _create_alien(self, alien_number, row_number):
            ...
            alien.rect.x = 10 * alien_width + 2 * alien_width * row_number
